...
\copy stg_departamentos (id_departamento, nombre_departamento, descripcion) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/departamentos.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_tipos_servicio (id_tipo_servicio, nombre_servicio) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/tipos_servicio.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_resultados_llamada (id_resultado, nombre_resultado) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/resultados_llamada.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_habilidades (id_habilidad, nombre_habilidad, descripcion) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/habilidades.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_turnos (id_turno, nombre_turno, hora_inicio, hora_fin, dias_semana) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/turnos.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_clientes (id_cliente, tipo_documento, numero_documento, nombre, apellido, direccion, ciudad, telefono, email, fecha_registro, estado_cliente) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/clientes.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_equipos_trabajo (id_equipo, nombre_equipo, id_departamento, descripcion) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/equipos_trabajo.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_agentes (id_agente, nombre, apellido, documento, cargo, telefono, email, fecha_ingreso, estado_agente, id_equipo, id_departamento) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/agentes.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_motivos_llamada (id_motivo, nombre_motivo, descripcion, id_tipo_servicio) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/motivos_llamada.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_agente_habilidad (id_agente, id_habilidad) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/agente_habilidad.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_agente_turno (id_agente_turno, id_agente, id_turno, fecha_inicio, fecha_fin) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/agente_turno.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_facturas (id_factura, id_cliente, numero_factura, fecha_emision, fecha_vencimiento, valor_total, estado_factura) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/facturas.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_pagos (id_pago, id_factura, fecha_pago, valor_pagado, metodo_pago, estado_pago) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/pagos.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_encuestas_satisfaccion (id_encuesta, id_llamada, id_cliente, calificacion, comentario, fecha_encuesta) FROM 'D:/Documents/1_A_HENN/1_UNIVERSIDAD/0_MAKAIA/PROYECTO_MAESTRO/SQL%Python/data/_smoke_test_call_center/encuestas_satisfaccion.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
