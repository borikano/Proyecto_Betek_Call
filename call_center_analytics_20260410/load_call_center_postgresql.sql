...
\copy stg_departamentos (id_departamento, nombre_departamento, descripcion) FROM 'call_center_analytics_20260410/departamentos.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_tipos_servicio (id_tipo_servicio, nombre_servicio) FROM 'call_center_analytics_20260410/tipos_servicio.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_resultados_llamada (id_resultado, nombre_resultado) FROM 'call_center_analytics_20260410/resultados_llamada.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_habilidades (id_habilidad, nombre_habilidad, descripcion) FROM 'call_center_analytics_20260410/habilidades.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_turnos (id_turno, nombre_turno, hora_inicio, hora_fin, dias_semana) FROM 'call_center_analytics_20260410/turnos.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_clientes (id_cliente, tipo_documento, numero_documento, nombre, apellido, direccion, ciudad, telefono, email, fecha_registro, estado_cliente) FROM 'call_center_analytics_20260410/clientes.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_equipos_trabajo (id_equipo, nombre_equipo, id_departamento, descripcion) FROM 'call_center_analytics_20260410/equipos_trabajo.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_agentes (id_agente, nombre, apellido, documento, cargo, telefono, email, fecha_ingreso, estado_agente, id_equipo, id_departamento) FROM 'call_center_analytics_20260410/agentes.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_motivos_llamada (id_motivo, nombre_motivo, descripcion, id_tipo_servicio) FROM 'call_center_analytics_20260410/motivos_llamada.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_agente_habilidad (id_agente, id_habilidad) FROM 'call_center_analytics_20260410/agente_habilidad.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_agente_turno (id_agente_turno, id_agente, id_turno, fecha_inicio, fecha_fin) FROM 'call_center_analytics_20260410/agente_turno.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_productos_servicios_cliente (id_producto_cliente, id_cliente, nombre_producto_servicio, categoria, fecha_adquisicion, estado_producto) FROM 'call_center_analytics_20260410/productos_servicios_cliente.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_facturas (id_factura, id_cliente, numero_factura, fecha_emision, fecha_vencimiento, valor_total, estado_factura) FROM 'call_center_analytics_20260410/facturas.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_pagos (id_pago, id_factura, fecha_pago, valor_pagado, metodo_pago, estado_pago) FROM 'call_center_analytics_20260410/pagos.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_casos (id_caso, id_cliente, id_tipo_servicio, id_motivo, descripcion_caso, fecha_apertura, fecha_cierre, estado_caso, resuelto_primer_contacto, prioridad) FROM 'call_center_analytics_20260410/casos.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
...
\copy stg_encuestas_satisfaccion (id_encuesta, id_llamada, id_cliente, calificacion, comentario, fecha_encuesta) FROM 'call_center_analytics_20260410/encuestas_satisfaccion.csv' WITH (FORMAT csv, HEADER true, ENCODING 'UTF8');
